    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->lineEdit_recherche_c2->setValidator(validator);
...
void MainWindow::on_pushButton_ajoutdelit_clicked()
{
...
void MainWindow::on_pushButton_supprimercriminel_clicked()
{
...
void MainWindow::on_pushButton_recherchercriminel2_clicked()
{
    QUrl url ;
  url = QUrl("C:/Users/Ilyes/Downloads/button.wav");
    ...
    QSqlQuery query;
    int ID_CRIMINEL=ui->lineEdit_recherche_c2->text().toInt();
...
void MainWindow::on_pushButton_exportercriminel_clicked()
{
...
void MainWindow::on_pushButton_changerlight_clicked()
{
    QUrl url ;
  url = QUrl("C:/Users/Ilyes/Downloads/button.wav");
     ...
     mmMediaPlayer->play();
        ...
        ui->label_modech->setText("Light Mode");
...
void MainWindow::on_pushButton_changerdark_clicked()
{
    QUrl url ;
  url = QUrl("C:/Users/Ilyes/Downloads/button.wav");
     ...
     mmMediaPlayer->play();
        ...
        file.open(QFile::ReadOnly);
        QString styleSheet = QString::fromLatin1(file.readAll());
ui->label_modech->setText("Dark Mode");
        // Option 1: Set theme for the inner central widget
        //ui->centralWidget->setStyleSheet(styleSheet);
...
void MainWindow::on_pushButton_changerorange_clicked()
{
    QUrl url ;
  url = QUrl("C:/Users/Ilyes/Downloads/button.wav");
     ...
     mmMediaPlayer->play();
        ...
        file.open(QFile::ReadOnly);
        QString styleSheet = QString::fromLatin1(file.readAll());
        ui->label_modech->setText("Dark orange");
