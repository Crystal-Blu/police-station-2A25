    ...
    , ui(new Ui::MainWindow)
{
    ...
    login log(this);
     ...
     QString password=log.getpassword();

   /*  QSqlQuery qry;
     qry.prepare( " select * from POLICIER where nom= '"+username+"' and idp= '"+password+"' " );
     bool test = qry.exec( ) ;*/
...
mmMediaPlayer = new QMediaPlayer (this);
        ...
        {
   QMessageBox::information(nullptr, QObject::tr("OK"), QObject::tr("wrong username/password.\n""Click Cancel to exit."), QMessageBox::Cancel);
    exit(EXIT_FAILURE);
        }
};
